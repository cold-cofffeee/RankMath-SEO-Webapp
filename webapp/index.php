    ...
    <div class="app-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <a href="#" class="nav-item" data-view="seo-analysis">
                    <span class="icon">🔍</span>
                    SEO Analysis
                </a>
                <a href="#" class="nav-item" data-view="competitor">
                ...
                <a href="#" class="nav-item" data-view="content-ai">
                    <span class="icon">🤖</span>
                    Content AI
                </a>
                <a href="#" class="nav-item" data-view="local-seo">
                    <span class="icon">📍</span>
                    Local SEO
                </a>
                <a href="#" class="nav-item" data-view="image-seo">
                    <span class="icon">🖼️</span>
                    Image SEO
                </a>
                <a href="#" class="nav-item" data-view="sitemaps">
                    <span class="icon">🗺️</span>
                    Sitemaps
                </a>
                <a href="#" class="nav-item" data-view="404-monitor">
                    <span class="icon">⚠️</span>
                    404 Monitor
                </a>
                <a href="#" class="nav-item" data-view="redirections">
                    <span class="icon">↪️</span>
                    Redirections
                </a>
            </nav>
